...
# Elimizdeki veri seti üzerinden minimum hata ile ev fiyatlarını tahmin eden bir makine öğrenmesi modeli geliştirildi
...
# eni değişkenler oluşturunuz ve oluşturduğumuz yeni değişkenlerin başına 'NEW' ekledik
...
##################
# BONUS : Log dönüşümü yaparak model kurunuz ve rmse sonuçlarını gözlemleyelim
